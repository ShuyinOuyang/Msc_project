...
for condition in condition_list:
    ...
    # if all the attributes from more than one table
        ...
        for attribute in condition:
            ...
            view = generate_left_join_view(attribute, target_query_attribute, target_query_attribute_tables, reachable_matrix,
        ...
        if len(sql_view_part) == 1:
            ...
            for i in range(len(where_conditions)):
                ...
                print(sql_select_template)
                el_template = generate_el_template(el_restrictions[i], reachable_matrix, all_tables, target_table,
                                                   foreign_key_matrix)
                print(el_template)
...
# ontology_template = 'patient and seenBy (doctor and hasSex value xxx)'
# atomic = '( description )'
# description = 'primary and primary'
# primary = 'restriction'
# restriction = 'x some primary' or 'x value primary'
# x could be dataProperty and objectProperty
